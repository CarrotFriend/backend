...
public class UserService {
    ...
    public User getUserByUserId(String userId){
        return em.createQuery("select distinct u from User u left join fetch u.userToCategoryList where u.userId like :userId", User.class)
                .setParameter("userId", userId)
                .getSingleResult();
    }

    public User getUserByEmail(String email){
        return em.createQuery("select distinct u from User u left join fetch u.userToCategoryList where u.email like :email", User.class)
    ...
    public void checkUserId(String userId) {
        Long cnt = em.createQuery("select count(u) from User u where u.userId =:userId", Long.class)
